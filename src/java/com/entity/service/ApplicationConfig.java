...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(com.entity.service.BrandCategoryFacadeREST.class);
        resources.add(com.entity.service.BrandFacadeREST.class);
        resources.add(com.entity.service.BrandInterestedFacadeREST.class);
        resources.add(com.entity.service.CategoryFacadeREST.class);
        resources.add(com.entity.service.CategoryInterestedFacadeREST.class);
        ...
        resources.add(com.entity.service.UsersFacadeREST.class);
    }
